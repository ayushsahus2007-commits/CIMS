...
def intro():
    ...
    print("{:^80s}".format("MADE BY: Shubham, SOUNAK MAITI AND AYUSH SAHU"))
...
def create_record():
    ...
    sql = "INSERT INTO contact_information(name,address,phone_no,email) VALUES (%s,%s,%s,%s)"
    record = (name,address,phone_no,email)
...
def search(name):
    ...
    if record is None:
        ...
        print('Address of Contact:', record[1])
        print('Phone Number of Contact:', record[2])
        print('E-mail id of Contact:', record[3])


def display_all():
    cursor.execute("SELECT * FROM contact_information")
    print('NAME','\t\t', 'ADDRESS','\t', '  PHONE_NO','\t', '  E-MAIL')
...
def modify_record(name):
    ...
    if record is None:
        ...
        while True:
            ...
            print("2. Address of Contact")
            print("3. Phone Number of Contact")
            print("4. Email id of Contact")
            print("5. Move Back to the Main Menu")
            print()
            ...
            if ch == 1:
                ...
                print("Invalid choice !!! ...Please enter appropriate choice(1/2/3/4/5)\n")
